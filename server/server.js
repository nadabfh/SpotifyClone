...
const defaultPlaylists = require("./data/playlists.json").playlists;
const defaultSongs = require("./data/songs.json").songs;
...
const server = app.listen(PORT, () => {
  dbService.connectToServer(DB_CONSTS.DB_URL).then(() => {
    ...
    dbService.populateDb(DB_CONSTS.DB_COLLECTION_PLAYLISTS, defaultPlaylists);
    dbService.populateDb(DB_CONSTS.DB_COLLECTION_SONGS, defaultSongs);
